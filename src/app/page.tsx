...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col items-center  h-screen gap-8">
      ...
      <div className="flex-row min-h-screen w-[100%]">
        ...
        <div className="h-[400px] bg-[#818CF8]"></div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 px-4">
    ...
    <div className="bg-purple-100 flex flex-col items-center text-center rounded-t-lg rounded-b-full p-6 shadow-md">
      <img className="w-24 h-24 rounded-full mb-4" src="https://via.placeholder.com/150" alt="User 1"/>
    ...
    <div className="bg-orange-100 flex flex-col items-center text-center rounded-t-lg rounded-b-full p-6 shadow-md">
      <img className="w-24 h-24 rounded-full mb-4" src="https://via.placeholder.com/150" alt="User 2"/>
    ...
    <div className="bg-purple-100 flex flex-col items-center text-center rounded-t-lg rounded-b-full p-6 shadow-md">
      <img className="w-24 h-24 rounded-full mb-4" src="https://via.placeholder.com/150" alt="User 3"/>
    ...
    <div className="bg-orange-100 flex flex-col items-center text-center rounded-t-lg rounded-b-full p-6 shadow-md">
      <img className="w-24 h-24 rounded-full mb-4" src="https://via.placeholder.com/150" alt="User 4"/>
    ...
    <div className="bg-purple-100 flex flex-col items-center text-center rounded-t-lg rounded-b-full p-6 shadow-md">
      <img className="w-24 h-24 rounded-full mb-4" src="https://via.placeholder.com/150" alt="User 5"/>
